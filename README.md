...
4. **Locates** your GitHub profile repo (the repo named after your username, e.g. `satyam-fp/satyam-fp`).
...
No configuration needed. The plugin infers your GitHub username from the current repo's remote URL and looks for the matching profile repo at the sibling directory level.
...
- Claude Code CLI
- A local clone of your GitHub profile repo (the repo named `<your-username>/<your-username>`)
